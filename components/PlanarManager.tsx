...
import { PlanarOverlay, PlanarAlignment } from '../types';
import { PLANAR_COLORS } from '../theme';
import { Plus, Trash2, Move, Layers, X, GripVertical, CheckCircle2 } from 'lucide-react';
                ...
                >
                    ...
                    <div className="space-y-2 pl-5">
                         ...
                         <div className="flex justify-between text-[10px] text-slate-500">
                             <span>POS: {Math.round(overlay.coordinates.x)}, {Math.round(overlay.coordinates.y)}</span>
