...
export const HexGrid: React.FC<HexGridProps> = ({
  ...
  const gpu = useGpuResources(gpuCanvasRef, hexesRef, worldConfigRef);
  ...
  }, [computeViewProjection, camera, tickKeys, gpu.scene]);
